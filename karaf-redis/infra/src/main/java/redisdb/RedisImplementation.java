...
public class RedisImplementation implements ICommands {
	...
	private RedisImplementation getSyncAndSetCommand(String key, String value) {
		this.connection.sync().set(key, value);
		return this;
	}
	
	private RedisImplementation getSyncAndHashSetCommand(String key, String field, String value) {
		this.connection.sync().hset(key, field, value);
		return this;
	}
	
	private RedisImplementation getSyncAndMapHashSetCommand(String key, Map<String, String> map) {
	...
	private RedisImplementation getSyncAndGetCommand(String key) {
		this.returnedSyncValue = this.connection.sync().get(key);
		return this;
	}
	
	private RedisImplementation getSyncAndHashGetCommand(String key, String field) {
	...
	// START INFRA REGION
	private RedisImplementation closeConnection() {
		this.connection.close();
		return this;
	}

	private RedisImplementation shutDownRedisClient() {
		this.redisClient.shutdownAsync();
		return this;
	}

	private RedisImplementation createConnection() {
